...
/**
 * A synchronized implementation of the {@link Array} interface that
 * uses Java built-in synchronized statements to ensure thread-safe
 * access to the state managed by this class.
 */
