...
class ParallelStreamsCrawlerTests : AssignmentTests() {
    ...
    fun `processPage() uses expected lambdas`() {
        ...
        val mockPageElements = mockk<CustomArray<WebPageElement>>()
        ...
        every { mockPageElements.parallelStream() } returns spyPageElementStream
        ...
        verify(exactly = 1) {
            ...
            mockPageElements.parallelStream()
